  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 mx-auto px-4 text-center">
        ...
        <div className="hero-fade-in flex justify-center items-center gap-4 mt-10">
          <a 
            href="https://instagram.com/dkgmetalcraft" 
            target="_blank" 
            rel="noopener noreferrer"
            className="w-10 h-10 rounded-full border border-[var(--color-border)] flex items-center justify-center text-[var(--text-steel)] hover:text-[#E1306C] hover:border-[#E1306C] hover:shadow-[0_0_15px_rgba(225,48,108,0.3)] hover:-translate-y-1 transition-all duration-300 group bg-[var(--bg-panel)]/50"
